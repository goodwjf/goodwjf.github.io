...
(function(window, undefined) {
    ...
    function _toMap(val, delimiter) {
        delimiter = delimiter === undefined ? ',' : delimiter;
        var map = {}, arr = _isArray(val) ? val : val.split(delimiter),
            match;
        _each(arr, function(key, val) {
    ...
    KEditor.prototype = {
        ...
        handler: function(key, fn) {
            //console.log( this.handler.caller.toString());
            ...
            //console.log(key+":"+self._handlers[key]);

            if (_isFunction(fn)) {
                if (key == "clickToolbartable" || key == "clickToolbarimage" ) {
					if(self._handlers[key].length == 1){ return;}
    ...
    _plugin('core', function(K) {
        ...
        _each(('prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,' +
            ...
            self.addContextmenu({
                ...
                click: function() {
                    //console.log("----loadPlugin---start-----");
                    self.loadPlugin('table', function() {
                        //	console.log("----loadPlugin----end----");
